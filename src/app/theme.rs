...
pub(crate) fn apply_theme(ctx: &egui::Context) {
    ...
    visuals.selection.bg_fill = egui::Color32::from_rgb(74, 42, 104);
    ...
    visuals.widgets.hovered.bg_fill = egui::Color32::from_rgb(54, 32, 76);
    visuals.widgets.hovered.weak_bg_fill = egui::Color32::from_rgb(54, 32, 76);
    visuals.widgets.hovered.bg_stroke = active_stroke;
    visuals.widgets.hovered.fg_stroke = egui::Stroke::new(1.0, TERMINAL_TEXT);
    visuals.widgets.active.bg_fill = egui::Color32::from_rgb(76, 44, 112);
    visuals.widgets.active.weak_bg_fill = egui::Color32::from_rgb(76, 44, 112);
    visuals.widgets.active.bg_stroke = active_stroke;
    visuals.widgets.active.fg_stroke = egui::Stroke::new(1.0, TERMINAL_TEXT);
    visuals.widgets.open.bg_fill = egui::Color32::from_rgb(54, 32, 76);
    visuals.widgets.open.weak_bg_fill = egui::Color32::from_rgb(54, 32, 76);
